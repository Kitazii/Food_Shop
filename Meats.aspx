<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Meats.aspx.cs" Inherits="Template_Project.Page3" %>
...
<head runat="server">
    ...
    <style>
        body{
            background-image:url('https://static.vecteezy.com/system/resources/previews/006/772/538/original/top-view-of-lunch-meat-on-a-wooden-tray-free-vector.jpg'); background-attachment:fixed; background-size:cover;background-repeat:no-repeat
        }
        a:link{
            font-size:18px;
        }
    ...
    <form id="form1" runat="server" style="height:100vh; width:100vw">
        ...
        <div class ="row">            
            ...
            <div class="col-sm-2">
                <asp:LinkButton ID="lnkMeats" runat="server" BackColor="#9900CC" BorderStyle="Groove" OnClick="lnkMeats_Click">Meats</asp:LinkButton>
            </div>
            <div class="col-sm-2">
        ...
        <div style="font-family:'Cascadia Mono'; color:white; background-color:black" >
            <asp:GridView ID="grdMeats" runat="server" Width="100%" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="meatsCalBtn" HeaderText="CALORIES TOTAL" />
                </Columns>
            </asp:GridView>
        </div>
        ...
        <div style="margin-left:auto; margin-right:auto; text-align:center; font-family:'Cascadia Mono';">
            <asp:Button ID="btnClearCal" runat="server" Text="Clear Calories Count" OnClick="btnClearCal_Click" BorderStyle ="Groove" BackColor ="Red" />
        </div>
