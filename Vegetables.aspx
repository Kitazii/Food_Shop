...
<head runat="server">
    ...
    <style>
        body{
            background-image:url('https://wallpaperaccess.com/full/438025.jpg'); background-attachment:fixed; background-size:cover;background-repeat:no-repeat
        }
        a:link{
            font-size:18px;
        }
    ...
    <form id="form1" runat="server" style="height:100vh; width:100vw">
        ...
        <div class ="row">            
            ...
            <div class="col-sm-2">
                <asp:LinkButton ID="lnkVegetables" runat="server" BackColor="#9900CC" BorderStyle="Groove" OnClick="lnkVegetables_Click">Vegetables</asp:LinkButton>
            </div>
            <div class="col-sm-2">
        ...
        <div style="font-family:'Cascadia Mono'; color:white; background-color:black" >
            <asp:GridView ID="grdVegetables" runat="server" Width="100%" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="vegetablesCalBtn" HeaderText="CALORIES TOTAL" />
                </Columns>
            </asp:GridView>
        </div>
        ...
        <div style="margin-left:auto; margin-right:auto; text-align:center; font-family:'Cascadia Mono'">
            <asp:Button ID="btnClearCal" runat="server" Text="Clear Calories Count" OnClick="btnClearCal_Click" BorderStyle ="Groove" BackColor ="Yellow" />
        </div>
