...
<body>
    <style>
        body{
            background-image:url('https://static.vecteezy.com/system/resources/previews/005/640/676/original/organic-seamless-pattern-with-random-dragon-fruit-ornament-in-pink-color-light-striped-background-vector.jpg'); background-attachment:fixed; background-size:cover;background-repeat:no-repeat
        }
        a:link{
            font-size:18px;
        }
    ...
    <form id="form1" runat="server" style="height:100vh; width:100vw">
        ...
        <div class ="row">            
            <div class="col-sm-2 offset-sm-1"  >
                <asp:LinkButton ID="lnkFruits" runat="server" BackColor="#9900CC" BorderStyle="Groove" OnClick="lnkFruits_Click">Fruits</asp:LinkButton>            
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <asp:LinkButton ID="lnkContactUs" runat="server" BackColor="Black" BorderStyle="Groove">Contact Us</asp:LinkButton>
            </div>
        </div>
        
        <div style="font-family:'Cascadia Mono'; color:white; background-color:black" >
            <asp:GridView ID="grdFruits" runat="server" Width="100%" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="fruitsCalBtn" HeaderText="CALORIES TOTAL" />
                </Columns>
            </asp:GridView>
        </div>
        ...
        <div style="margin-left:auto; margin-right:auto; text-align:center; font-family:'Cascadia Mono'">
            <asp:Button ID="btnClearCal" runat="server" Text="Clear Calories Count" OnClick="btnClearCal_Click" BorderStyle ="Groove" BackColor ="Green"/>
        </div>
